...
@section('content')
    <div class="container-xxl mt-4">
        <h1 class="mb-5" style="color: #07382F"><a href="{{route('buyerDashboard')}}" class="btn btn-success" style="background-color: #07382F;color: #fff"><i class="fa fa-arrow-left"> Back </i></a> || {{$purchase_title}}</h1>
        <div class="row">
