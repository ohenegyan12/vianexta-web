...
<style>
    ...
    .selectable-card:hover {
        ...
        box-shadow: 0 8px 15px rgba(216, 80, 28, 0.2);
        background-color: #FFF5F2;
        border-color: #D8501C;
    }

    .selectable-card.activate_option {
        background-color: #D8501C;
        border-color: #D8501C;
        transform: translateY(-5px);
        box-shadow: 0 8px 15px rgba(216, 80, 28, 0.3);
    }

    .selectable-card.activate_option p {
        color: #ffffff;
    }

    .selectable-card.activate_option img {
            ...
            <div class="wizard my-5">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" role="tabpanel" id="step1" aria-labelledby="step1-tab">
                        <h4 class="text-center mb-4">What kind of coffee bean are you looking for?</h4>
                        <div class="d-flex mb-5 py-lg-5 cards-row justify-content-center flex-wrap">
                            <input type="hidden" id="session_roast" value="{{session('roast')}}">
                            ...
                            <button class="option-button" onclick="setPressedOption('roast','whole_sale_brand',this)">
                                <div id="whole_sale_brand" class="card selectable-card border-0 py-2 px-4">
                                    <div class="card-body">
                                        <div class="card-content">
                                            <img src="{{ asset('images/buyer/whole_sale_brand_icon.svg') }}" alt="whole brand image" style="height: 80px;" class="h-60 w-full">
                                            <p id="roast_whole_sale_brand_txt" class="card-text text-center mt-3">Whole Sale Brand</p>
                                        </div>
                                    </div>
                                </div>
                            </button>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <a id="roast_no_option_btn" style="display:none" href="{{route('buyerGreenMarketPlace')}}" class="btn btn-primary">Continue</a>
                            <a id="roast_whole_sale_brand_option_btn" style="display:none" href="{{route('buyerWholeMarketPlace')}}" class="btn btn-primary">Continue</a>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" role="tabpanel" id="step4" aria-labelledby="step4-tab">
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-md-3">
                                <h5 class="mb-4">Select your package size and customize it</h5>

                                <!-- Package Options -->
                                <div class="package-options mb-4">
                                    <div class="package-option" data-size="5lb" onclick="selectPackage('5lb', this)">
                                        <span>5lb Bag</span>
                                        <span class="package-arrow">&gt;</span>
                                    </div>
                                    <div class="package-option active" data-size="12oz" onclick="selectPackage('12oz', this)">
                                        <span>12oz Bag</span>
                                        <span class="package-arrow">&gt;</span>
                                    </div>
                                    <div class="package-option" data-size="frac_pack" onclick="selectPackage('frac_pack', this)">
                                        <span>Frac Packs</span>
                                        <span class="package-arrow">&gt;</span>
                                    </div>
                                    <div class="package-option" data-size="10oz" onclick="selectPackage('10oz', this)">
                                        <span>10oz Bag</span>
                                        <span class="package-arrow">&gt;</span>
                                    </div>
                                    <div class="package-option" data-size="kcup" onclick="selectPackage('kcup', this)">
                                        <span>K Cup</span>
                                        <span class="package-arrow">&gt;</span>
                                    </div>
                                </div>
                            ...
                            <!-- Center Column - Package Preview -->
                            <div class="col-12 col-md-6">
                                <div class="package-preview">
                                    <div class="main-preview mb-3">
                                        <img src="{{ asset('images/buyer/12oz_1.png') }}" alt="Preview" class="preview-img" id="package-preview-img">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="package-details">
                                    <div class="package-title" id="package-title">12oz Bag</div>
                                    ...
                                    <div class="package-quantity" id="quantity-section">
                                        <div class="quantity-label">Quantity</div>
                                        <select class="quantity-select" id="numBags" onchange="getAmount()">
                                            <option value="6">6 Bags min.</option>
                                            <option value="12">12 Bags</option>
                                            <option value="24">24 Bags</option>
                                            <option value="48">48 Bags</option>
                                        </select>
                                    </div>
                                </div>
...
<script src="{{ asset('js/session_selected_items.js') }}"></script>

<!-- Package Selection and Preview JavaScript -->
<script>
    ...
    let currentPackageSize = '12oz';

    // Function to select package
    function selectPackage(size, element) {
        ...
        // Update package details and preview
        updatePackageDetails(size);
        updatePackagePreview(size);
    ...
    function updatePackageDetails(size) {
        ...
        packageTitle.textContent = product.title;
    ...
    function updatePackagePreview(size) {
        const product = productData[size];
        const previewImg = document.getElementById('package-preview-img');
        const designOverlay = document.getElementById('designOverlay');

        // Update main image
        previewImg.src = `../images/buyer/${product.mainImage}`;
        currentMainImage = `../images/buyer/${product.mainImage}`;

        // Update design overlay class
        designOverlay.className = `design-overlay-${size}`;
    ...
    // Function to show complete next button
    function showCompleteNextButton(numBags) {
        if (numBags && numBags > 0) {
            document.querySelector('#btn_roast_next a').style.display = 'block';
        } else {
            document.querySelector('#btn_roast_next a').style.display = 'none';
        }
    }

    // Function to get amount (placeholder for quantity calculation)
    function getAmount() {
        const numBags = document.getElementById('numBags').value;
        showCompleteNextButton(numBags);
    }

    // Initialize package selection on page load
    document.addEventListener('DOMContentLoaded', function() {
        // Set default package (12oz)
        selectPackage('12oz', document.querySelector('.package-option[data-size="12oz"]'));

        // Initialize dropzone
        initializeDropzone();

        // Initialize logo drag functionality
        initializeLogoDrag();
        ...
        fracPackRadios.forEach(radio => {
            radio.addEventListener('change', function() {
                if (this.checked) {
                    ...
                    saveBagOption(`frac_pack_${selectedSize}`);
                ...
                init: function() {
                    ...
                    this.on('addedfile', function(file) {
                        ...
                        reader.onload = function(e) {
                            $('#logoOverlay').attr('src', e.target.result);
...
<script type="text/javascript">
    ...
    function setPressedOption(option, content, clickedOption) {
        ...
        if (option != "bag_size" && option != "num_of_bags") {
            activateCardOptions(option, content, clickedOption);
        }

        if (option == "product" && content == '') {
            showProdNextBtn('');
            return;
        }
    ...
    function activateCardOptions(option, content, clickedOption) {
        ...
        var whole_sale_brand_option = document.getElementById("whole_sale_brand");
        ...
        var txt_whole_sale_brand_roast = document.getElementById("roast_whole_sale_brand_txt");
        ...
        if (option == "roast") {
            ...
            whole_sale_brand_option.classList.remove("activate_option");

            // Add active class based on selection
            if (content == "yes") {
                roasted_option.classList.add("activate_option");
            } else if (content == "whole_sale_brand") {
                whole_sale_brand_option.classList.add("activate_option");
            } else {
        ...
        if (option == "product") {
            ...
            // alert('I got here ' + content + ' and ' + clickedOption);

            var elems = document.querySelectorAll("#product_type");
    ...
    function triggerRoastBtn(option, content) {
        ...
        var roast_whole_sale_brand_option_btn = document.getElementById("roast_whole_sale_brand_option_btn");

        if (content == "no") {
            roast_yes_option_btn.style.display = "none";
            roast_whole_sale_brand_option_btn.style.display = "none";
            roast_no_option_btn.style.display = "block";
            if (event && event.type === 'click') {
                window.location.href = "{{ route('buyerGreenMarketPlace') }}";
            }
        } else if (content == "whole_sale_brand") {
            roast_yes_option_btn.style.display = "none";
            roast_no_option_btn.style.display = "none";
            roast_whole_sale_brand_option_btn.style.display = "block";
            if (event && event.type === 'click') {
                window.location.href = "{{ route('buyerWholeMarketPlace') }}";
            }
        } else {
    ...
    function showProdNextBtn(option) {
        if (option == '') {
            document.getElementById("btn_prod_selection_next").style.display = "none";
        } else {
            document.getElementById("btn_prod_selection_next").style.display = "block";
            showNextTab();
        }
    }
</script>
